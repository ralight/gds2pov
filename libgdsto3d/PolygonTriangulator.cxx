...
void PolygonTriangulator::Polygon::initializate()
{
  ...
  for(; it!=_points.end(); ++it)
      ...
      else
	{
	  ...
	  if( pprev > p && pnext > p ) _points[id]->type=(area >0.0) ? internal_poltrig::END: internal_poltrig::MERGE ;
	  if( pprev < p && pnext < p ) _points[id]->type=(area >0.0) ? internal_poltrig::START : internal_poltrig::SPLIT;
