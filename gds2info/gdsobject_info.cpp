/*
 * File: gdsobject_info.cpp
 * Author: Roger Light
 * Project: gdsto3d
 *
 * This is the INFO-RAY output specific implementation of the GDSObject class.
 *
...
GDSObject_info::GDSObject_info(char *Name) : GDSObject(Name){
}

GDSObject_info::~GDSObject_info()
{
}
